...
def example_function(string_arg: str, int_arg: int, to_print:bool=False, extra_value:float=10.0) -> str:
    ...
    return f"{string_arg} {int_arg} {extra_value} {int_arg + extra_value}"
...
command.add_node(pg.Operand("extra_value", float))
...
print(parser.execute("main sub yes 10 -to_print --extra_value=13.9"))
